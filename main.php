...
<body class="page">
	...
	<div id="loading" style="visibility: hidden">
		<img src='assets/loading_background.png' class="loading_background">
		<img src='assets/loading_icon.gif' class="loading_icon">
	</div>
    ...
    <div class="bandeau_top" id="bandeau_top">
    	...
    	<div class="bar_form1">
    		<input type="text" id="Summoner_Name" value="" placeholder="Summoner name" class="input_name">
	        ...
	        <!--<input type="date" id="DateGame" class="input_nbgame" value="2020-07-22" min="2015-01-01" max="2020-12-31">-->
	        ...
	        <!--<SELECT id="Role" size="1" class="input_role">
	            <OPTION>Ø Role
	            <OPTION>Top
	            <OPTION>Jungle               BADGE dans les game liste + pos
	            <OPTION>Mid
	            <OPTION>ADC
	            <OPTION>Support 
	        </SELECT>-->
	    ...
	    <div>
	        ...
	        <button id="Select_Game_Button" class="Select_Game_Button">Update Graph</button>
	    </div>
    ...
    <div class="middle2" id="accueil">
        <img src='assets/Title-web2.png' class="logo2"  href="main.php">
            ...
            <div class="other_form2">
                ...
                <input type="date" id="DateGame_Bis" class="input_date2" value="2020-07-22" min="2015-01-01" max="2020-12-31">
